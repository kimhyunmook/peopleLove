...
exports.JudgeModule = JudgeModule = __decorate([
    (0, common_1.Module)({
        imports: [open_ai_module_1.OpenAiModule],
        controllers: [judge_controller_1.JudgeController, open_ai_controller_1.OpenAiController],
        providers: [judge_service_1.JudgeService, open_ai_service_1.OpenAiService],
    })
], JudgeModule);
